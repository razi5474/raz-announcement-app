# Raz Announcement App

A Shopify app that lets store admins set an announcement banner that appears on the storefront.

## Tech Stack
- React + React Router (Shopify scaffold)
- Node.js + Shopify Admin GraphQL API
...
5. Follow the CLI prompts to connect to your Shopify development store.

## Features
- Admin dashboard to set announcement text
- Saves to MongoDB with timestamp for audit history
- Syncs to Shopify Shop Metafield (my_app.announcement)
- Theme App Extension displays banner on storefront via Liquid
